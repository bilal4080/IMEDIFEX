...
const Banner = () => {
    return (
        <div className="w-full md:w-max pl-6 flex flex-col md:flex-row items-center justify-center mt-6">
            {/* First Card */}
            <div className="w-full md:w-96 h-52 bg-[#5EEF8F] rounded-lg md:ml-4 md:mr-2 flex items-center justify-center mb-4 md:mb-0">
                <img
                    src="/1.png"
                    alt="Online Doctors"
            ...
            {/* Second Card */}
            <div className="w-full md:w-max h-52 bg-[#ebdfef] flex rounded-lg md:ml-4 md:mr-4">
                <div className="flex items-center justify-start p-4 pl-10">
                    <div>
                        ...
                        <button className="px-3 py-1 md:px-4 md:py-2 bg-[#5EEF8F] text-white rounded-md hover:shadow-lg transition-transform transform hover:scale-105">
                            Download Now
                        </button>
                    </div>
                </div>
